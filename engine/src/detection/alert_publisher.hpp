#pragma once
// engine/src/detection/alert_publisher.hpp
// Serialises a RuleMatch into the api_spec v1.1 alert JSON, publishes it to
// the siem.alerts Kafka topic, and persists it to the ClickHouse aegis.alerts table.
...
public:
    AlertPublisher(const Config&                              cfg,
