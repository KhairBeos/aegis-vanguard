#pragma once
// engine/src/pipeline/event_validator.hpp
// Parses raw JSON from Kafka, validates against api_spec v1.1 contract,
// and extracts hot columns into a ParsedEvent struct.
